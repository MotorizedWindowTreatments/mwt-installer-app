...
function buildItineraryPdfBlob(itinerary, opts) {
  ...
  const summaryRows = [
    ...
    ["Field Service Calls", String(totals.fieldServiceCalls)],
    ["Cut-downs", String(totals.cutDowns)],
    ["Motorization Retrofits", String(totals.motorizationRetrofits)],
    ["Drapery Track Builds", String(totals.draperyTrackBuilds)],
    ["In-house Repairs", String(totals.inHouseRepairs)],
    ["Warehouse Organization", String(totals.warehouseOrganization)],
